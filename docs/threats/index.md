# :material-shield-alert: Threat Intelligence Overview
...
- **15** active advisories across all sources
- **18** new KEV entries in the last 30 days
- **847** new CVEs published in the last 14 days
- **87** recent malicious URLs tracked
